...
public class TelaInicial extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        //Deletar o componente selecionado
        try{
            if(idComponente!=null && idEquipamento!=null 
                && JOptionPane.showConfirmDialog(btoAddComponente, "Deseja deletar o componente?")== JOptionPane.YES_OPTION){
                controle.deletNode(idComponente, idEquipamento);//Adiciona um novo componente.
                JOptionPane.showMessageDialog(btoAddComponente, "Removido!");
                carregaTreeView();
            }
        }catch(Exception e){
            JOptionPane.showMessageDialog(btoAddComponente, e);
